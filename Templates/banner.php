<?php
	function initialize_banner() {
		...
		echo "					<h2>Earth, the only planet we can call home, is 4.543 billion years old. But with the way we've been treating her, it doesn't seem likely that she'll last very long. 
